      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex gap-6 items-center">
            <Link href="/search" className="text-white/60 hover:text-white transition-colors font-medium">
              Événements
            </Link>
            <Link href="/search?type=music" className="text-white/60 hover:text-white transition-colors font-medium">
              Concerts
            </Link>
            <Link href="/search?type=sports" className="text-white/60 hover:text-white transition-colors font-medium">
              Sport
            </Link>
        ...
        {isOpen && (
          <div className="md:hidden pb-4 space-y-3 border-t border-white/5 pt-4">
            <Link href="/search" onClick={() => setIsOpen(false)}
              className="block text-white/60 hover:text-white transition-colors font-medium py-1">
              Événements
            </Link>
