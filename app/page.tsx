...
const HOW_IT_WORKS = [
  ...
  { step: "02", icon: "✈️", title: "Compose ton séjour", desc: "Ajoute ton vol, ton hôtel et tes billets en quelques clics." },
  { step: "03", icon: "🎟️", title: "Réserve en 1 paiement", desc: "Tout confirmé instantanément. Tu n'as plus qu'à y aller." },
];

const TRUST_ITEMS = [
  { emoji: "🛡️", title: "Billets officiels garantis", desc: "100 % issus de billetteries certifiées, jamais de revendeurs non vérifiés." },
  { emoji: "🤝", title: "Partenaires de référence", desc: "Ticketmaster, Fnac Spectacles, See Tickets et d'autres acteurs agréés." },
  { emoji: "🔒", title: "Paiement sécurisé", desc: "Chiffrement SSL et protection de l'acheteur à chaque transaction." },
  { emoji: "💬", title: "Assistance dédiée", desc: "Une question avant ou après réservation ? Notre équipe vous répond." },
];
